  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="flex items-center justify-between p-6 bg-charcoal-dark/90 backdrop-blur sticky top-0 z-10 border-b border-charcoal-light">
        ...
        <div>
          <a href="#projects" className="mr-8 font-medium text-gray-300 hover:text-accent transition">Projects</a>
          <a href="#contact" className="font-medium text-gray-300 hover:text-accent transition">Contact</a>
        </div>
      </nav>
      ...
      <header className="flex flex-col-reverse md:flex-row items-center justify-center gap-10 py-24 px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mt-8 flex justify-center md:justify-start gap-4">
            <a href="#projects" className="px-6 py-3 bg-accent text-charcoal-dark rounded-lg hover:bg-accent-hover transition font-bold shadow-lg shadow-accent/20">See My Work</a>
        ...
        >
          ...
          <img src={profilePic} alt="Profile" className="relative w-full h-full rounded-full object-cover border-4 border-charcoal" />
        </motion.div>
      </header>
      ...
      <section id="projects" className="p-10 max-w-6xl mx-auto">
        <h3 className="text-3xl font-bold mb-8 text-center text-white">Latest Projects</h3>
      ...
      <section id="contact" className="py-20 px-4 bg-charcoal-dark">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">Have a question or want to build something together?</p>
        </div>
        <ContactForm />
      </section>
      <footer className="bg-charcoal text-gray-500 text-center py-8 border-t border-charcoal-light">
        <p>&copy; {new Date().getFullYear()} Brandon "iamagenus" Lewandowski. All rights reserved.</p>
      </footer>
    </div>
  );
}
